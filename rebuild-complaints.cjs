    ...
    <div class="sidebar">
      ...
      <div class="sidebar-card">
        ...
        <div class="related-list">
          <a href="complaint-letter-electricity-board-power-cut.html" class="related-item">
            <div class="related-icon">⚡</div>
            <div class="related-text"><div class="r-name">বিদ্যুৎ অভিযোগ</div><div class="r-views">১৫,৬৭৮ বার দেখা</div></div>
          </a>
          <a href="complaint-letter-water-shortage.html" class="related-item">
            <div class="related-icon">💧</div>
            <div class="related-text"><div class="r-name">পানি সংকট</div><div class="r-views">১২,৪৫৬ বার দেখা</div></div>
          </a>
          <a href="complaint-letter-road-damage.html" class="related-item">
            <div class="related-icon">🛣️</div>
            <div class="related-text"><div class="r-name">রাস্তার ক্ষতি</div><div class="r-views">৮,৫৪৩ বার দেখা</div></div>
          </a>
        </div>
      </div>
    </div>
