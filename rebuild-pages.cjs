...
// Bengali content for ALL pages
const allPages = {
  // LEAVE APPLICATIONS
  'application-leave-due-to-fever.html': {
    title: 'জ্বরের ছুটির আবেদন',
    desc: 'অসুস্থতা বা জ্বরের কারণে প্রধান শিক্ষক বা ম্যানেজারের কাছে ছুটির আবেদন পত্রের সঠিক ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'অসুস্থতা',
    recipient: 'প্রধান শিক্ষক / বিভাগীয় প্রধান',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'জ্বরের কারণে ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। গত [তারিখ] থেকে আমি উচ্চ জ্বরে আক্রান্ত হয়েছি।',
      'ডাক্তারের পরামর্শ অনুযায়ী আমাকে সম্পূর্ণ বিশ্রাম প্রয়োজন। তাই আমি [তারিখ] থেকে [তারিখ] পর্যন্ত [সংখ্যা] দিনের ছুটি প্রার্থনা করছি।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে উক্ত সময়ের জন্য ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['ডাক্তারের প্রেসক্রিপশন সংযুক্ত করুন', 'সঠিক তারিখ উল্লেখ করুন', 'অভিভাবকের স্বাক্ষর নিন (ছাত্রদের জন্য)'],
    mistakes: ['অস্পষ্ট কারণ উল্লেখ করা', 'তারিখ না দেওয়া', 'চিকিৎসক সনদ না সংযুক্ত করা'],
    faqs: [
      {q:'জ্বরের ছুটি কতদিন পাওয়া যায়?', a:'সাধারণত ৩-৭ দিন, ডাক্তারের সনদ অনুযায়ী।'},
      {q:'ডাক্তারের সনদ কি বাধ্যতামূলক?', a:'৩ দিনের বেশি ছুটির জন্য সাধারণত বাধ্যতামূলক।'}
    ]
  },
  'application-sick-leave.html': {
    title: 'অসুস্থতার ছুটির আবেদন',
    desc: 'অসুস্থতার কারণে ছুটির আবেদন পত্রের সঠিক বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'অসুস্থতা',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'অসুস্থতার কারণে ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। হঠাৎ অসুস্থ হয়ে পড়ায় আমি বিদ্যালয়/অফিসে উপস্থিত হতে অক্ষম।',
      'আমার ডাক্তারি পরীক্ষা চলছে এবং চিকিৎসক আমাকে [সংখ্যা] দিন বিশ্রামের পরামর্শ দিয়েছেন।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে [তারিখ] থেকে [তারিখ] পর্যন্ত অসুস্থতার ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['চিকিৎসক সনদ সংযুক্ত করুন', 'অসুস্থতার ধরন উল্লেখ করুন', 'ফিরে আসার তারিখ জানান'],
    mistakes: ['অসুস্থতার ধরন না বলা', 'চিকিৎসক সনদ না দেওয়া', 'ফিরে আসার তারিখ না জানানো'],
    faqs: [
      {q:'অসুস্থতার ছুটি কতদিন পাওয়া যায়?', a:'রোগের ধরন অনুযায়ী ১-১৪ দিন পর্যন্ত।'},
      {q:'কী কী কাগজপত্র লাগে?', a:'চিকিৎসক সনদ, প্রেসক্রিপশন কপি।'}
    ]
  },
  'application-casual-leave.html': {
    title: 'সাধারণ ছুটির আবেদন',
    desc: 'ব্যক্তিগত কাজের জন্য সাধারণ ছুটির আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'সাধারণ',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'সাধারণ ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। আমার কিছু জরুরি ব্যক্তিগত কাজ থাকায় আমি [তারিখ] তারিখে বিদ্যালয়/অফিসে উপস্থিত হতে পারব না।',
      'আমি আমার অনুপস্থিতিতে ক্লাস/কাজের ক্ষতি পূরণ করে নেব।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে উক্ত দিনের জন্য সাধারণ ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['কাজের ধরন সংক্ষেপে উল্লেখ করুন', 'আগে থেকে আবেদন করুন', 'ক্ষতি পূরণের আশ্বাস দিন'],
    mistakes: ['অস্পষ্ট কারণ দেওয়া', 'শেষ মুহূর্তে আবেদন করা', 'ক্ষতি পূরণের কথা না বলা'],
    faqs: [
      {q:'সাধারণ ছুটি কতদিন পাওয়া যায়?', a:'সাধারণত ১-৩ দিন।'},
      {q:'কারণ না বললে কি ছুটি পাওয়া যায়?', a:'না, ন্যূনতম কারণ উল্লেখ করতে হয়।'}
    ]
  },
  'application-sister-wedding-leave.html': {
    title: 'বোনের বিয়ের ছুটির আবেদন',
    desc: 'বোনের বিয়েতে উপস্থিত থাকার জন্য ছুটির আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'পারিবারিক',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'বোনের বিয়েতে উপস্থিত থাকার জন্য ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। আগামী [তারিখ] তারিখে আমার বোনের বিবাহ অনুষ্ঠান অনুষ্ঠিত হতে যাচ্ছে।',
      'এই পারিবারিক অনুষ্ঠানে উপস্থিত থাকার জন্য আমার [সংখ্যা] দিনের ছুটি প্রয়োজন।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে [তারিখ] থেকে [তারিখ] পর্যন্ত ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['বিয়ের তারিখ উল্লেখ করুন', 'আগে থেকে আবেদন করুন', 'পারিবারিক সম্পর্ক স্পষ্ট করুন'],
    mistakes: ['তারিখ না দেওয়া', 'শেষ মুহূর্তে আবেদন করা', 'সম্পর্ক স্পষ্ট না করা'],
    faqs: [
      {q:'বিয়ের ছুটি কতদিন পাওয়া যায়?', a:'সাধারণত ৩-৭ দিন।'},
      {q:'কী কী প্রমাণ লাগে?', a:'বিয়ের কার্ড বা পরিবারের সনদ।'}
    ]
  },
  'application-family-function-leave.html': {
    title: 'পারিবারিক অনুষ্ঠানের ছুটি',
    desc: 'পারিবারিক অনুষ্ঠানে উপস্থিত থাকার জন্য ছুটির আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'পারিবারিক',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'পারিবারিক অনুষ্ঠানে উপস্থিত থাকার জন্য ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। আমাদের পরিবারে [অনুষ্ঠানের ধরন] অনুষ্ঠান অনুষ্ঠিত হতে যাচ্ছে [তারিখ] তারিখে।',
      'এই পারিবারিক অনুষ্ঠানে আমার উপস্থিতি একান্ত প্রয়োজন। তাই আমি [সংখ্যা] দিনের ছুটি প্রার্থনা করছি।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে উক্ত সময়ের জন্য ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['অনুষ্ঠানের ধরন উল্লেখ করুন', 'তারিখ স্পষ্ট করুন', 'আগে থেকে আবেদন করুন'],
    mistakes: ['অনুষ্ঠানের ধরন না বলা', 'তারিখ না দেওয়া', 'শেষ মুহূর্তে আবেদন করা'],
    faqs: [
      {q:'পারিবারিক অনুষ্ঠানের ছুটি কতদিন পাওয়া যায়?', a:'সাধারণত ১-৩ দিন।'},
      {q:'কী ধরনের অনুষ্ঠানে ছুটি পাওয়া যায়?', a:'বিয়ে, ব্রত, শ্রাদ্ধ ইত্যাদি।'}
    ]
  },
  'application-urgent-piece-of-work.html': {
    title: 'জরুরি কাজের ছুটি',
    desc: 'জরুরি ব্যক্তিগত কাজের জন্য ছুটির আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'জরুরি',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'জরুরি ব্যক্তিগত কাজের জন্য ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। আমার কিছু জরুরি ব্যক্তিগত কাজ থাকায় আমি [তারিখ] তারিখে উপস্থিত হতে পারব না।',
      'এই কাজটি অত্যন্ত জরুরি এবং তাৎক্ষণিকভাবে সম্পন্ন করা প্রয়োজন।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে উক্ত দিনের জন্য জরুরি ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['জরুরি কারণ সংক্ষেপে উল্লেখ করুন', 'এক দিনের মধ্যে আবেদন করুন', 'কাজ শেষে ফিরে আসার আশ্বাস দিন'],
    mistakes: ['অস্পষ্ট কারণ দেওয়া', 'অতিরিক্ত ছুটি চাওয়া', 'ফিরে আসার তারিখ না দেওয়া'],
    faqs: [
      {q:'জরুরি ছুটি কি হঠাৎ নেওয়া যায়?', a:'হ্যাঁ, তবে কারণ উল্লেখ করতে হয়।'},
      {q:'কতদিনের জরুরি ছুটি পাওয়া যায়?', a:'সাধারণত ১-২ দিন।'}
    ]
  },
  'application-going-home-leave.html': {
    title: 'বাড়ি যাওয়ার ছুটি',
    desc: 'বাড়ি যাওয়ার জন্য ছুটির আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'ব্যক্তিগত',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'বাড়ি যাওয়ার জন্য ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। দীর্ঘদিন বাড়ি না যাওয়ায় আমি [তারিখ] তারিখে বাড়ি যেতে চাই।',
      'আমার পরিবারের সদস্যরা আমার অপেক্ষায় আছেন এবং তাদের সাথে দেখা করা আমার পক্ষে জরুরি।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে [তারিখ] থেকে [তারিখ] পর্যন্ত ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['বাড়ির দূরত্ব উল্লেখ করুন', 'ফিরে আসার তারিখ দিন', 'আগে থেকে আবেদন করুন'],
    mistakes: ['ফিরে আসার তারিখ না দেওয়া', 'অতিরিক্ত ছুটি চাওয়া', 'কারণ না বলা'],
    faqs: [
      {q:'বাড়ি যাওয়ার ছুটি কতদিন পাওয়া যায়?', a:'সাধারণত ২-৫ দিন, দূরত্ব অনুযায়ী।'},
      {q:'উৎসবে বাড়ি যাওয়ার ছুটি কি আলাদা?', a:'হ্যাঁ, উৎসব ছুটি আলাদাভাবে বিবেচিত হয়।'}
    ]
  },
  'application-medical-appointment-leave.html': {
    title: 'চিকিৎসা অ্যাপয়েন্টমেন্টের ছুটি',
    desc: 'ডাক্তারের অ্যাপয়েন্টমেন্টে যাওয়ার জন্য ছুটির আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'চিকিৎসা',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'চিকিৎসা অ্যাপয়েন্টমেন্টের জন্য ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। আমার ডাক্তারের অ্যাপয়েন্টমেন্ট রয়েছে [তারিখ] তারিখে [সময়] সময়ে।',
      'এই অ্যাপয়েন্টমেন্টে যাওয়া আমার স্বাস্থ্যের জন্য অত্যন্ত জরুরি।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে উক্ত দিনের জন্য ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['অ্যাপয়েন্টমেন্টের সময় উল্লেখ করুন', 'ডাক্তারের সনদ সংযুক্ত করুন', 'ফিরে আসার সময় জানান'],
    mistakes: ['সময় না দেওয়া', 'ডাক্তারের সনদ না সংযুক্ত করা', 'ফিরে আসার সময় না জানানো'],
    faqs: [
      {q:'চিকিৎসা অ্যাপয়েন্টমেন্টের ছুটি কি বেতনসহ?', a:'হ্যাঁ, সাধারণত বেতনসহ ছুটি দেওয়া হয়।'},
      {q:'কতদিন আগে আবেদন করতে হয়?', a:'সম্ভব হলে ১-২ দিন আগে।'}
    ]
  },
  'application-dental-appointment-leave.html': {
    title: 'দাঁতের চিকিৎসার ছুটি',
    desc: 'দাঁতের ডাক্তারের অ্যাপয়েন্টমেন্টে যাওয়ার জন্য ছুটির আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'ছুটি', catIcon: '🌴', subcategory: 'চিকিৎসা',
    recipient: 'প্রধান শিক্ষক / ব্যবস্থাপক',
    institution: '[বিদ্যালয় / প্রতিষ্ঠানের নাম]',
    city: '[শহর, জেলা]',
    subject: 'দাঁতের চিকিৎসার জন্য ছুটির আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [শ্রেণি/বিভাগ]-এর ছাত্র/কর্মচারী। আমার দাঁতের সমস্যার কারণে ডেন্টিস্টের অ্যাপয়েন্টমেন্ট রয়েছে [তারিখ] তারিখে।',
      'এই চিকিৎসা আমার স্বাস্থ্যের জন্য অত্যন্ত জরুরি এবং তাৎক্ষণিকভাবে সম্পন্ন করা প্রয়োজন।',
      'অতএব, বিনীত অনুরোধ জানাচ্ছি যে, আমাকে উক্ত দিনের জন্য ছুটি মঞ্জুর করে বাধিত করবেন।'
    ],
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/পদবী] | [রোল/আইডি নম্বর]',
    tips: ['ডেন্টিস্টের অ্যাপয়েন্টমেন্ট কার্ড সংযুক্ত করুন', 'চিকিৎসার ধরন উল্লেখ করুন', 'ফিরে আসার সময় জানান'],
    mistakes: ['অ্যাপয়েন্টমেন্ট কার্ড না সংযুক্ত করা', 'চিকিৎসার ধরন না বলা', 'ফিরে আসার সময় না জানানো'],
    faqs: [
      {q:'দাঁতের চিকিৎসার ছুটি কি বেতনসহ?', a:'হ্যাঁ, সাধারণত বেতনসহ ছুটি দেওয়া হয়।'},
      {q:'কতবার দাঁতের চিকিৎসার ছুটি পাওয়া যায়?', a:'প্রয়োজন অনুযায়ী, সাধারণত ১-৩ দিন।'}
    ]
  },
  'application-bonafide-certificate.html': {
    title: 'বোনাফাইড সার্টিফিকেট আবেদন',
    desc: 'বোনাফাইড সার্টিফিকেট পাওয়ার জন্য আবেদন পত্রের বাংলা ফরম্যাট।',
    category: 'সার্টিফিকেট', catIcon: '📜', subcategory: 'শিক্ষা',
    recipient: 'অধ্যক্ষ / প্রধান শিক্ষক',
    institution: '[বিদ্যালয় / কলেজের নাম]',
    city: '[শহর, জেলা]',
    subject: 'বোনাফাইড সার্টিফিকেট প্রদানের আবেদন',
    salutation: 'মহোদয়,',
    body: [
      'সবিনয় নিবেদন এই যে, আমি [আপনার নাম], [বিভাগ/শ্রেণি]-এর নিয়মিত ছাত্র/ছাত্রী। আমার রোল নম্বর [রোল নম্বর] এবং রেজিস্ট্রেশন নম্বর [রেজিস্ট্রেশন নম্বর]।',
    ...
    closing: 'বিনীত নিবেদন',
    signName: '[আপনার নাম]',
    signInfo: '[শ্রেণি/বিভাগ] | [রোল নম্বর]',
    tips: ['রোল নম্বর উল্লেখ করুন', 'সার্টিফিকেটের উদ্দেশ্য জানান', 'প্রয়োজনীয় কাগজপত্র সংযুক্ত করুন'],
    mistakes: ['রোল নম্বর না দেওয়া', 'উদ্দেশ্য না জানানো', 'কাগজপত্র না সংযুক্ত করা'],
    faqs: [
      {q:'বোনাফাইড সার্টিফিকেট পেতে কতদিন লাগে?', a:'সাধারণত ২-৩ কর্মদিবস।'},
      {q:'কী কী কাগজপত্র লাগে?', a:'পরিচয় পত্র, রোল নম্বর, সার্টিফিকেটের উদ্দেশ্য।'}
    ]
  }
};
...
// Generate all pages
Object.entries(allPages).forEach(([slug, data]) => {
...
console.log(`\n✅ Generated ${Object.keys(allPages).length} pages with proper Bengali content and template`);
